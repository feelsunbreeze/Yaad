...
export function SettingsModal(props: SettingsModalProps) {
  ...
  return (
    <Show when={props.isOpen}>
      <div class={`modal-overlay ${isClosing() ? 'closing' : ''}`} onClick={handleClose}>
        <div class="modal-content" onClick={e => e.stopPropagation()}>
          ...
          <Show when={!confirmReset()}>
            ...
            <div class="settings-section">
              ...
              <div class="settings-actions">
                <button class="settings-btn danger" onClick={() => setConfirmReset(true)}>Delete Database (Factory Reset)</button>
              </div>
            </div>
          </Show>
          ...
          <Show when={confirmReset()}>
            <div class="settings-section">
              ...
              <p class="settings-desc">This will permanently delete all your reminders and history. This cannot be undone.</p>
              <div class="settings-actions" style="margin-top: 1rem;">
                <button class="settings-btn danger" onClick={doReset}>Yes, factory reset</button>
                <button class="settings-btn" onClick={() => setConfirmReset(false)}>Cancel</button>
              </div>
            </div>
          </Show>
        </div>
