...
export default function App() {
  ...
  return (
    <div class="app">
      <Titlebar hidden={loadingInitial()} />

      <Show when={loadingInitial()}>
        <div class="splash-screen">
          <YaadLogo animate class="splash-logo" />
        </div>
      </Show>
      ...
      <Show when={!loadingInitial()}>
        ...
        <SettingsModal
          ...
          onClose={() => { playSfx("tabSwitch"); setIsSettingsOpen(false); }}
        ...
        <ReminderList
          ...
          inlineReschedule={r.inlineReschedule()}
        />
        ...
        <SnoozeModal
          ...
          onClose={() => { playSfx("tabSwitch"); setSnoozeReminder(null); }}
